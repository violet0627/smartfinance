...
class _SecuritySettingsScreenState extends State<SecuritySettingsScreen> {
  ...
  Future<void> _handleToggle2FA() async {
    if (_twoFactorEnabled) {
      ...
      // Must use && not || — using || would call _loadSecurityData even when unmounted (crash)
  ...
  Widget _buildSessionTile(Map<String, dynamic> session) {
    ...
    try {
      ...
      // parsing failed — lastActiveDate stays null
    }
  ...
  Widget _buildLogTile(Map<String, dynamic> log) {
    ...
    // API can return true (bool) or 1 (int) for success status
    ...
    try {
      ...
      // parsing failed — timestamp stays null
    }

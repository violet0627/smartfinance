...
class _TwoFactorSetupScreenState extends State<TwoFactorSetupScreen> {
  ...
  Future<void> _verifyAndEnable() async {
    ...
    try {
      ...
      if (result['success']) {
        // pushReplacement so the user can't navigate back to the setup screen after enabling 2FA
      ...
      children: [
        ...
        if (_qrCode.isNotEmpty)
          Container(
            ...
            child: Column(
              children: [
                // QR code arrives as a data URL: "data:image/png;base64,..."
                // .split(',')[1] strips the prefix; base64Decode converts to raw bytes
                Image.memory(

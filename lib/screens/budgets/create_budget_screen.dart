...
class _CreateBudgetScreenState extends State<CreateBudgetScreen> {
  ...
  // Allows up to RM 1.00 unallocated to absorb rounding from "Distribute Evenly"
  bool get _isValid {
  ...
  Future<void> _selectMonth() async {
    final DateTime? picked = await showDatePicker(
      ...
      // firstDate must be in the past to allow editing budgets from previous months
      // without Flutter's assertion error (initialDate must not be before firstDate)

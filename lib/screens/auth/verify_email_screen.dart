  ...
  Future<void> _handleResendVerification() async {
    ...
    if (result['success']) {
      ...
      if (result['verificationToken'] != null) {
        setState(() => _tokenController.text = result['verificationToken']);
      }
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                maxLines: 3,
                validator: (value) {
                  if (value == null || value.isEmpty) return 'Please enter the verification token';
                  return null;
                },
              ),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const Text('How to verify:', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                      ],
                    ),
                    const SizedBox(height: 8),

...
import '../../widgets/two_factor_verification_dialog.dart';
  ...
  Future<void> _handleLogin() async {
    ...
    if (result['success']) {
      ...
      if (twoFactorEnabled) {
        ...
        if (!verified) {
          // Must log out explicitly — the JWT was issued on login before 2FA was checked
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: const Text('Verify Now', style: TextStyle(fontSize: 14)),
                    ),
                  ],
                ),
              ],

...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  @override
  void dispose() {
    _passwordController.removeListener(_checkPasswordStrength); // Remove before dispose to avoid setState on dead widget
                ...
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                    builder: (_) => VerifyEmailScreen(
                      email: _emailController.text.trim(),
                      token: result['verificationToken'], // null in prod; token string in dev for auto-fill
                    ),
                  ),
                );
              },
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    ...
                    // Malaysian phone format: 01X-XXXXXXX

...
class LevelProgressWidget extends StatelessWidget {
  ...
  Widget _buildFullView(Color levelColor, String levelTitle) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [levelColor.withOpacity(0.15), Colors.white],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
          ...
          Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('${stats.xpProgressInLevel} XP', style: TextStyle(fontSize: 11, color: Colors.grey.shade600)),
                  Text('${stats.xpForNextLevel} XP', style: TextStyle(fontSize: 11, color: Colors.grey.shade600)),
                ],
              ),
            ],
          ),

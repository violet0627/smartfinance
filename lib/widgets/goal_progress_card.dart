                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _buildStatRow('Active Goals', activeGoals.toString(), Icons.flag, AppColors.primary),
                          const SizedBox(height: 8),
                          _buildStatRow('Completed', completedGoals.toString(), Icons.check_circle, AppColors.success),
                          const SizedBox(height: 8),
                          _buildStatRow('Total Saved', 'RM ${NumberFormat('#,##0').format(totalSaved)}', Icons.savings, AppColors.warning),
                        ],
                      ),
                    ),
                  ],
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 12),
                        Text('No active goals', style: TextStyle(fontSize: 16, color: Colors.grey.shade600)),
                        const SizedBox(height: 4),
                        Text('Tap to create your first goal', style: TextStyle(fontSize: 14, color: Colors.grey.shade500)),
                      ],
                    ),
                  ),
                ),

...
class _CategoryPieChartState extends State<CategoryPieChart> {
    ...
    return Column(
      ...
      children: [
        ...
        ConstrainedBox(
          ...
          child: SingleChildScrollView(child: _buildLegend()),
        ),
      ],
    );
  }
  ...
  List<PieChartSectionData> _getSections(double total) {
    ...
    return sortedEntries.asMap().entries.map((entry) {
      ...
      final categoryInfo = TransactionCategories.getCategoryInfo(category, widget.type);
  ...
  Widget _buildLegend() {
    ...
    return Wrap(
      ...
      children: sortedEntries.map((entry) {
        final categoryInfo = TransactionCategories.getCategoryInfo(entry.key, widget.type);
          ...
          child: Row(
            ...
            children: [
              Container(
                width: 12,
                height: 12,
                decoration: BoxDecoration(color: categoryInfo.color, shape: BoxShape.circle),
              ),

class BudgetModel {
  ...
  double get totalSpent => categories.fold(0.0, (sum, cat) => sum + cat.spentAmount);
  double get totalRemaining => totalBudget - totalSpent;
  double get percentageUsed => totalBudget == 0 ? 0.0 : (totalSpent / totalBudget) * 100;
...
class BudgetCategoryModel {
  ...
  double get percentageUsed => allocatedAmount == 0 ? 0.0 : (spentAmount / allocatedAmount) * 100;

...
class UserAchievement {
  ...
  // Parses milestone numbers (100, 30, 7) from unlock criteria text to compute progress %.
...
class UserStats {
  ...
  double get levelProgress =>
      xpForNextLevel == 0 ? 0.0 : (xpProgressInLevel / xpForNextLevel * 100).clamp(0.0, 100.0);
...
class HabitStreak {
  ...
  // Active if the user tracked today (0 days ago) or yesterday (1 day ago)
  bool get isActive {

...
class AnalyticsService {
  ...
  // isAfter/isBefore are exclusive, so subtract/add 1 day to make the range inclusive
  ...
  // DateTime handles month overflow automatically (e.g. month -2 wraps back correctly)
